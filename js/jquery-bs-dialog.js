...
** jquery-bs-dialog.js
**
** Shift4 grown jquery-ui-dialog replacement that works with native bootstrap. Used jquery-ui widget as a template because we wanted a compatible replacement widget.
...
+function ($) {
	...
	var Dialog = function (element, options) {
		...
		var buttons = [], buttonsclick = [], btn_count = 0;
		...
		for(var i=0; i<buttonsclick.length; i++){
			var btn = buttonsclick[i], that = this;
